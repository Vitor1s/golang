...
// func bytes2(){
//     // PACOTE OS:
//     // os.Open() - Abre um arquivo existente para leitura
//     // Retorna (*os.File, error) - ponteiro para o arquivo + possível erro
//     arquivo, err := os.Open("meus_logs.txt")
//     if err != nil {
//         log.Fatal(err)
//     }
//     // defer arquivo.Close() - Garante que o arquivo será fechado 
//     // quando a função terminar, mesmo se der erro
//     defer arquivo.Close()

//     // PACOTE BYTES:
//     // new(bytes.Buffer) - Cria um buffer vazio em memória
//     // Buffer é como um "container" que pode armazenar dados
//     buffer := new(bytes.Buffer)
    
//     // buffer.ReadFrom(arquivo) - Lê TODO o conteúdo do arquivo
//     // e coloca dentro do buffer. O arquivo é "consumido" (cursor vai pro final)
//     buffer.ReadFrom(arquivo)
    
//     // buffer.String() - Converte o conteúdo do buffer para string
//     // fmt.Println() - Imprime a string no console
